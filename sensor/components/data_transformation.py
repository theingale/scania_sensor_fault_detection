...
class DataTransformation:
    ...
    def initiate_data_transformation(self,) -> DataTransformationArtifact:
        try:
            # Read data and preprocessor object
            ...
            logging.info("Data scaling and imputing completed")
            ...
            logging.info("Data imbalanced handled successfully")
            ...
            logging.info("Final train and test arrays created")
